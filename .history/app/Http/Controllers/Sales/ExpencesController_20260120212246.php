...
class ExpencesController extends Controller
{
    ...
    public function getExpenseSummary(Request $request)
    {
        ...
        $categorySummary = $query->clone()
            ->join('expences_category', 'expences.category_id', '=', 'expences_category.id')
            ->selectRaw('expences_category.description as category, SUM(expences.amount) as total_amount')
            ->groupBy('expences.category_id', 'expences_category.description')
            ->get();
