    ...
    data() {
      return {
        ...
        menuItems: [
          ...
          { title: 'Warehouse', icon: 'mdi-home-plus', route: '/WareHouseList' },
            { title: 'Warehouse Trans', icon: 'mdi-transfer', route: '/warehousetransition' },
             ], },
          ...
          { title: 'Customer', icon: 'mdi-account', route: '/customerlist' },
          {
            ...
            subItems: [
              ...
              { title: 'Kitchen', icon: 'mdi-receipt', route: '/kitchen' }
