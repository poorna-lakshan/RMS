...
class ExpencesController extends Controller
{
    ...
    public function createExpense(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'category_id' => 'required|integer|exists:expences_categories,id',
    ...
    {
        $query = Expences::with(['category', 'warehouse', 'user'])
    ...
    public function getExpenseSummary(Request $request)
    {
        ...
        $categorySummary = $query->clone()
            ->join('expences_categories', 'expences.category_id', '=', 'expences_categories.id')
            ->selectRaw('expences_categories.description as category, SUM(expences.amount) as total_amount')
            ->groupBy('expences.category_id', 'expences_categories.description')
            ->get();
        ...
        $dailySummary = $query->clone()
            ->selectRaw('expense_date, SUM(amount) as daily_total')
