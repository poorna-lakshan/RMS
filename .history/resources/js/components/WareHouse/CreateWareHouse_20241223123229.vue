    ...
    <v-card class="pa-6 elevation-12">
      ...
      <v-form ref="form">
        ...
        <v-card-actions>
          ...
          <v-btn color="warning" @click="clear" class="ma-2">
            Clear
          </v-btn>
          <v-btn color="grey" @click="go_back" class="ma-2">
            Back
          </v-btn>
        </v-card-actions>
      </v-form>
  ...
  methods: {
    ...
    async load_data(){
      try {
          ...
          this.form_data = response.data;  // Directly assign the single warehouse object to form_data
          } else {
