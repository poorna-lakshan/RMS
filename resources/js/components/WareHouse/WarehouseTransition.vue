    ...
    <v-container fluid>
      <v-card class="pa-6 elevation-12">
        ...
        <v-tooltip bottom>
          ...
          <span>Warehouse Transition </span>
        </v-tooltip>


        <v-card-title>
          <v-icon left size="24">mdi-transfer</v-icon>
      ...
      <v-dialog v-model="dialog" max-width="400">
        <v-card>
          <v-card-title>Warehouse Transition </v-card-title>
          <v-card-text>

            <v-select v-model="currentProduct.warehouse" :items="warehouses" label="Warehouses" required></v-select>
    ...
    data() {
      return {
        ...
        products: [
          ...
          { lineNo: 6, barcode: 'B006', itemCode: 'ITEM001', qoh: 10, unitCost: 100, sellingPrice: 150, receivedQuantity: 0, freeQuantity: 0, expireDate: '', expireDateMenu: false, selected: false },
          { lineNo: 7, barcode: 'B007', itemCode: 'ITEM002', qoh: 15, unitCost: 200, sellingPrice: 250, receivedQuantity: 0, freeQuantity: 0, expireDate: '', expireDateMenu: false, selected: false },
          { lineNo: 8, barcode: 'B008', itemCode: 'ITEM003', qoh: 5, unitCost: 150, sellingPrice: 200, receivedQuantity: 0, freeQuantity: 0, expireDate: '', expireDateMenu: false, selected: false },
          { lineNo: 9, barcode: 'B009', itemCode: 'ITEM004', qoh: 20, unitCost: 300, sellingPrice: 400, receivedQuantity: 0, freeQuantity: 0, expireDate: '', expireDateMenu: false, selected: false },
          { lineNo: 10, barcode: 'B010', itemCode: 'ITEM005', qoh: 8, unitCost: 250, sellingPrice: 300, receivedQuantity: 0, freeQuantity: 0, expireDate: '', expireDateMenu: false, selected: false },
        ],
